...
func toArrayForward<T: Equatable>(list: DoublyLinkedList<T>) -> [T] {
...
func toArrayBackward<T: Equatable>(list: DoublyLinkedList<T>) -> [T] {
    var array = [T]()
...
extension Array where Element : Equatable {
    ...
    func toDoublyLinkedList() -> DoublyLinkedList<Element> {
